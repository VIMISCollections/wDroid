...
adb -s $1 install $5
echo "Running monkey..."
adb -s $1 shell data/local/tmp/monkey -p $3 -v -v -v --ignore-crashes --ignore-timeouts --kill-process-after-error --ignore-security-exceptions --pct-syskeys 0 --pct-nav 0 99999 | tee $6/$3.txt
